...
OhdsiRTools::checkUsagePackage("EhdenRaDmardsEstimation")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/EhdenRaDmardsEstimation.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EhdenRaDmardsEstimation.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "EhdenRaDmardsEstimation")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("EhdenRaDmardsEstimation")
